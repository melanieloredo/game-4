...
#define room1_bg_bn_gfxTilesLen 352
extern const bn::tile room1_bg_bn_gfxTiles[11];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item room1_bg(
            regular_bg_tiles_item(span<const tile>(room1_bg_bn_gfxTiles, 11), bpp_mode::BPP_4, compression_type::NONE), 
